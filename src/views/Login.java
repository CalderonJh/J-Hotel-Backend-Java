...
public class Login extends JFrame {
	...
	public Login() {
		...
		btn_exit.setBounds(251, 0, 53, 36);
		...
		btn_exit.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				 btn_exit.setBackground(new Color(12, 138, 199));
			     labelExit.setForeground(Color.white);
			}
		});
		btn_exit.setBackground(new Color(12, 138, 199));
		...
		txt_user.setFont(new Font("Roboto", Font.PLAIN, 16));
		txt_user.setText("Ingrese su nombre de usuario");
		txt_user.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		txt_user.setForeground(SystemColor.activeCaptionBorder);
		txt_user.setBounds(65, 256, 324, 32);
		panel.add(txt_user);
		...
		txt_password.setForeground(SystemColor.activeCaptionBorder);
		txt_password.setFont(new Font("Roboto", Font.PLAIN, 16));
		txt_password.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		txt_password.setBounds(65, 353, 324, 32);
		...
		lbl_pass.setForeground(SystemColor.textInactiveText);
		lbl_pass.setFont(new Font("Roboto Black", Font.PLAIN, 20));
		lbl_pass.setBounds(65, 316, 140, 26);
		panel.add(lbl_pass);
