...
public class MainMenu extends JFrame {
	...
	public MainMenu() {
		...
		imagenFondo.setIcon(new ImageIcon(Objects.requireNonNull(MainMenu.class.getResource("/imagenes/menu-img.png"))));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(Objects.requireNonNull(MainMenu.class.getResource("/imagenes/aH-150px.png"))));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Hotel © 2023");
		...
		imagenLogin.setIcon(new ImageIcon(Objects.requireNonNull(MainMenu.class.getResource("/imagenes/login.png"))));
	...
	//Code that allows you to move the window around the screen following the position of "x" and "y"
