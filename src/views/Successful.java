...
public class Successful extends JDialog {
	...
	public Successful() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Successful.class.getResource("/imagenes/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Objects.requireNonNull(Successful.class.getResource("/imagenes/Ha-100px.png"))));
